...
$db['Lovers']['dbprefix'] = '';
$db['Lovers']['pconnect'] = TRUE;
$db['Lovers']['db_debug'] = TRUE;
$db['Lovers']['cache_on'] = FALSE;
$db['Lovers']['cachedir'] = '';
$db['Lovers']['char_set'] = 'utf8';
$db['Lovers']['dbcollat'] = 'utf8_general_ci';
$db['Lovers']['swap_pre'] = '';
$db['Lovers']['autoinit'] = TRUE;
$db['Lovers']['stricton'] = FALSE;
